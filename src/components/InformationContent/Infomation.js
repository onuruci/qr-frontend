...
const Information = () => {
    ...
    return <div className="information-container" id="about">
        ...
        <p className="second-main-text flex-row" style={{ gap: "0.5rem" }}>
            <div className="first-line">
                <span className="bold-black-24">Create</span> <span className="normal-black-24">your</span> <span className="bold-black-24">QR Code </span>
            </div>
            <div className="second-line">
                <span className="normal-black-24">with</span> <span className="bold-black-24">Logo </span>
            </div>
        </p>
        <div className="media-layout flex-row" style={{ paddingTop: "2rem", gap: "4rem", alignItems: "flex-start" }}>
